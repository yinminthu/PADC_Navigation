package xyz.phyoeyinminthu.padc_navigationview.utils;
...
import xyz.phyoeyinminthu.padc_navigationview.NavigationViewApp;
...
public class MMFontUtils {
    ...
    static {
        Context context = NavigationViewApp.getContext();
